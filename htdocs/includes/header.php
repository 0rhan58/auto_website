        ...
        <?php if(isset($_SESSION['id']) || isset($_SESSION['user_id'])){ ?>
            <div class="account">
                ...
                <div class="account-dropdown">
                    <ul>
                        <li><img src="/assets/images/icons/setting.svg" alt=""><a href="/account-info">Naar account</a></li>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (openHelpModal && helpModal) {
            openHelpModal.addEventListener('click', function (e) {
                e.preventDefault();
